...
public class AdminController {
    ...
    public String adminCommentList(HttpSession session, Model model, @RequestParam(name = "searchCnd", defaultValue = "") String searchCnd, @RequestParam(name = "keyword", defaultValue = "") String keyword, @PageableDefault(page = 1, size = 10, direction = Sort.Direction.DESC) Pageable pageable){
        ...
        Page<Comment> list = commentService.adminCommentListSearch(searchCnd, keyword, pageable);
